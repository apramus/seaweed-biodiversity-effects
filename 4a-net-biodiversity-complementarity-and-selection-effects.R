...
pAll
ggsave(pAll, file="./figures-and-tables/Figure4.pdf", dpi=1200, height=6, width=3)  # previously width = 4.33
#tiff(filename="./figures-and-tables/Figure4.tiff", height=6*800, width=3*800, units="px", res=800, compression="lzw")
#print(pAll)
#dev.off()
