...
nmds1
ggsave(nmds1, file="./figures-and-tables/Figure_3. NMDS effects on composition.pdf", height=3.22, width=3.22, dpi=1200)
...
write.csv(pairs, "./figures-and-tables/Table_S2. Planned contrasts for effects on composition.csv")
