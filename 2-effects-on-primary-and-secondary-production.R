...
print(histograms)
ggsave(histograms, file="./output/histograms-of-response-distributions.pdf", dpi=1200, height=8, width=10.5)
...
write.csv(stats, "./output/anova-summary-table-for-effects-on-response-metrics.csv")
